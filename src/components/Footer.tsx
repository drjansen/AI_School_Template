      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 rounded-lg bg-slate-800 border border-slate-700 flex items-center justify-center text-slate-400 hover:text-white hover:border-slate-600 transition-colors"
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-xs">
            ...
            <a href={`https://${brand.domain}`} className="hover:text-slate-300 transition-colors">
              {brand.domain}
            </a>
          </p>
          <p className="text-slate-600 text-xs">
            Running parallel to{" "}
            <a href="https://www.ics.kr" className="hover:text-slate-400 transition-colors" target="_blank" rel="noopener noreferrer">
              ICS (ics.kr)
            </a>
